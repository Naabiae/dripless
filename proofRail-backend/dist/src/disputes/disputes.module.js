...
const disputes_processor_1 = require("../queue/disputes.processor");
...
exports.DisputesModule = DisputesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [disputes_service_1.DisputesService, prisma_service_1.PrismaService, disputes_processor_1.DisputesProcessor],
